<template>
  <div>
    <el-form
      ...
      ref="checkboxQuestion"
      label-width="100px"
      :rules="rules"
    >
      <br />
      <el-form-item label="试题类题：" prop="type">
        <el-input placeholder="请输入内容" v-model="checkboxQuestion.type">
        </el-input>
      </el-form-item>
      ...
      <el-form-item>
        <div class="addBtn">
          <el-button
            type="primary"
            @click="save('checkboxQuestion')"
            v-if="!isEdit"
            >保存</el-button
          >
          <el-button type="primary" @click="edit('checkboxQuestion')" v-else
            >提交</el-button
          >
          <el-button @click="close('checkboxQuestion')" v-if="!isEdit"
            >取消</el-button
          >
