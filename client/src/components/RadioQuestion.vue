  ...
  <div>
    <el-form ref="form" label-width="100px">
      <el-form-item label="单选题：">
        <Editor class="RadioQuestion" v-model="radioQuestion.title" :init="editorInit"></Editor>
      </el-form-item>
      <el-form-item label="选项：">
        <el-radio disabled :label="item.key" v-for="(item, index) of radioQuestion.answerOption" :key="index">{{item.content}}</el-radio>
      </el-form-item>
      ...
      <el-form-item label="正确答案：">
        <el-radio-group v-model="radioQuestion.rightKey">
          <el-radio :label="item.key" v-for="(item, index) of radioQuestion.answerOption" :key="index">{{item.content}}</el-radio>
        </el-radio-group>
      </el-form-item>
      <el-form-item label="解答过程：">
        <Editor class="RadioQuestion" v-model="radioQuestion.solution" :init="editorInit"></Editor>
      </el-form-item>
      <el-form-item>
